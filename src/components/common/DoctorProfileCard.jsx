        ...
        <div className="mt-4 px-5 pb-5">
          ...
          <div className="mt-2 mb-2 flex items-center justify-between">
            <p>
              ...
              <span className="text-sm text-slate-900 line-through">₹1000</span>
            </p>
          ...
          <div className="text-sm mb-5 tracking-tight text-slate-500">
            <h7>Cardiologist</h7>
          </div>
          <a
            // href="dashboard/76"
            // eslint-disable-next-line react/prop-types
            onClick={() => props.setDoctorsCards(false)}
